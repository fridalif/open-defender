...
const (
	...
	NetworkMonitorProgKprobeTcpV4SendReset = "kprobe_tcp_v4_send_reset"
	NetworkMonitorProgKprobeUdpRcv         = "kprobe_udp_rcv"
)
...
type NetworkMonitorProgramSpecs struct {
	KprobeTcpV4SendReset *ebpf.ProgramSpec `ebpf:"kprobe_tcp_v4_send_reset"`
	KprobeUdpRcv         *ebpf.ProgramSpec `ebpf:"kprobe_udp_rcv"`
}
...
type NetworkMonitorPrograms struct {
	KprobeTcpV4SendReset *ebpf.Program `ebpf:"kprobe_tcp_v4_send_reset"`
	KprobeUdpRcv         *ebpf.Program `ebpf:"kprobe_udp_rcv"`
}

func (p *NetworkMonitorPrograms) Close() error {
	return _NetworkMonitorClose(
		p.KprobeTcpV4SendReset,
		p.KprobeUdpRcv,
	)
}
...
//
//go:embed networkmonitor_arm_bpfel.o
